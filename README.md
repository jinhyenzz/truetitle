...
네이버·다음 뉴스 기사에서 제목 위 버튼이나 확장프로그램 팝업의 **분석하기**를 누르면 결과를 볼 수 있습니다. 다른 한국어 언론사 기사는 팝업에서 해당 사이트의 접근 권한을 허용한 뒤 추출을 시도합니다. 현재는 로컬 API 서버와 연결해 사용하며, 외부 서버 배포와 Chrome 웹 스토어 등록은 아직 하지 않았습니다.
